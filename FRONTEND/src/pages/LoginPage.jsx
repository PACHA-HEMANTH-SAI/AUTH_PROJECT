...
const LoginPage = () => {
  ...
  return (
    ...
    className='max-w-md w-full bg-opacity-50 bg-gray-800 backdrop-blur-2xl backdrop-filter rounded-2xl shadow-xl overflow-hidden'
    >
      <div className='p-8'>
        ...
        <form onSubmit={handleLogin}>
          ...
          {error && <p className='font-semibold text-red-500 mb-4'>{error}</p>}
          ...
          type='submit'>
            ...
            {isLoading ? <Loader className = 'h-6 w-6 m-auto animate-spin' /> : "Login"}
          </motion.button>
        </form>

      </div>

      <div className='text-center px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center'>
